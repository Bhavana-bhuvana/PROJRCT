...
#         logistic_regression_page(data, features, target)
#     elif model_name == "Decision Tree":
#         decision_tree_classification_page(data, features, target)
#     elif model_name == "Random Forest":
#         random_forest_classification_page(data, features, target)
#     elif model_name == "SVM":
#         svm_classification_page(data, features, target)
#     elif model_name == "KNN":
#         knn_classification_page(data, features, target)
#     elif model_name == "Naive Bayes":
#         naive_bayes_classification_page(data, features, target)
#     else:
